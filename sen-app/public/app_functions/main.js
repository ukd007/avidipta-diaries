...
let onStrike = batsman1.name === (initialMatchState ? initialMatchState.onStrikeName : batsman1.name) ? batsman1 : batsman2;
let nonStriker = onStrike === batsman1 ? batsman2 : batsman1;

let overBalls = initialMatchState ? initialMatchState.overBalls : 0;
let totalRuns = initialMatchState ? initialMatchState.totalRuns : 0;
let wickets = initialMatchState ? initialMatchState.wickets : 0;
let pendingWicket = initialMatchState ? initialMatchState.pendingWicket : false;
let pendingBowlerModal = initialMatchState ? initialMatchState.pendingBowlerModal : false;

let bowlers = initialMatchState && initialMatchState.bowlers ? initialMatchState.bowlers : {
...
const historyStack = initialMatchState ? initialMatchState.historyStack : [];
